...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
allDataMat = zeros(numSubject,trialLength,freqLength,sampleLength,channelLength);
for subject = 1:numSubject
    allDataMat(subject,:,:,:,:) = allData{subject};
end
transferTemplate = zeros(numSubject,freqLength,sampleLength,channelLength);
for subject = 1:numSubject
    sidx = subjectSeq ~= subject;
    transferTemplate(subject,:,:,:) = squeeze(mean(mean(allDataMat(sidx,:,:,:,:))));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Recognition
timeSeq = 0.25:0.25:4;
...
for Nhidx = 1:length(NhSeq)
    ...
    for tidx = 1:length(timeSeq)
        ...
        parfor targetSubject = 1:numSubject
            ...
            XTemplate = squeeze(transferTemplate(targetSubject,:,startIdx+1:startIdx+floor(time*fsample),:));
